...
public class Aquarium extends GFX {
	...
	// create a new fish called nemo
	Fish nemo = new Fish(Color.red, true);
	// create another fish called dory
	Fish dory = new Fish(Color.cyan, false);
	...
	public Aquarium() {
		...
		super(WIDTH, HEIGHT);
		this.algorithm = new Snail(177,Snail.HEIGHT + 1, "top");
	}
